...
class QuestionController:
    ...
    async def create_question(self, question: QuestionCreate, current_user: User = Depends(AuthService.get_current_user)):
    ...
    async def get_all_questions(self, current_user: User = Depends(AuthService.get_current_user)):
        logger.info(f"{current_user.full_name} is getting all questions")
        return self.question_service.get_all_questions()

    async def get_question(self, question_id: int, current_user: User = Depends(AuthService.get_current_user)):
    ...
    async def get_full_question(self, question_id: int, current_user: User = Depends(AuthService.get_current_user)):
    ...
    async def update_question(self, question_id: int, question: QuestionCreate, current_user: User = Depends(AuthService.get_current_user)):
    ...
    async def delete_question(self, question_id: int, current_user: User = Depends(AuthService.get_current_user)):
    ...
    async def create_answer(self, question_id: int, answer: AnswerCreate,  current_user: User = Depends(AuthService.get_current_user)):
    ...
    async def get_answers(self, question_id: int,  current_user: User = Depends(AuthService.get_current_user)):
